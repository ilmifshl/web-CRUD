...
<?php if (isset($_SESSION["message"])) : ?>
    <div id="toast-success" class="absolute top-4 right-2 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow-md transition duration-200" role="alert">
        ...
        <button type="button" class="ml-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex h-8 w-8 transition duration-200" data-dismiss-target="#toast-success" aria-label="Close">
