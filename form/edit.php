    ...
    <div class="flex justify-center items-center">
        <div class="w-1/2 my-14">
            ...
            <div class="grid gap-6 md:grid-cols-2 mb-4 mt-4">
                    ...
                    <div class="relative">
                        <input type="text" id="nama" name="nama" pattern="[A-Za-z ]+" value="<?= $students["nama"] ?>" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-green-600 peer" placeholder=" " required />
                ...
                <div class="grid w-full gap-2 my-2">
                    <div class="flex gap-x-6">
                        ...
                        <div class="w-full">
                            <input type="radio" id="laki_laki" name="jenis_kelamin" value="laki-laki" class="hidden peer" <?= $students["jenis_kelamin"] == "Laki-Laki" ? "checked" : "" ?>>
                        ...
                        <div class="w-full">
                            <input type="radio" id="perempuan" name="jenis_kelamin" value="perempuan" class="hidden peer" <?= $students["jenis_kelamin"] == "Perempuan" ? "checked" : "" ?>>
                ...
                <div class="my-4">
                    <div class="relative">
                        <input type="email" name="email" id="email" value="<?= $students["email"] ?>" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-green-600 peer" placeholder=" " required />
