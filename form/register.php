        ...
        <div class="w-1/2 my-14">
            ...
            <form class="" action="../controller/register.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex justify-center items-center">
                    <button type="submit" name="register" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-16 py-2.5 text-center ">Daftar</button>
                </div>
